...
class Connect2PayClient {
   ...
   * @return The RebillStatus filled with values returned from the operation or
   *         null on failure (in that case call getClientErrorMessage())
   */
   ...
   * @return The CancelStatus filled with values returned from the operation or
   *         null on failure (in that case call getClientErrorMessage())
   */
...
class PaymentStatus {
   ...
   *          (collection, refund...)
   * @return The TransactionAttempt found or null if not found
   */
   ...
   *
   * @return A list with the transactions found (sorted by date, older first) or
  ...
  private static function copyScalarProperties($properties, $src, &$dest) {
...
class TransactionAttempt {
  /**
   * Type of payment for this transaction attempt: CreditCard, BankTransfer,
...
class SepaMandate {
   ...
   *
   * @return The date that mandate was signed at as DateTime object
   */
   ...
   *
   * @return The date that mandate was created at as DateTime object
   */
   ...
   *
   * @return The date that mandate was last used at as DateTime object
   */
